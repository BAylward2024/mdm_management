...
<?php if($editions instanceof \Illuminate\Pagination\AbstractPaginator): ?>
<div class="mt-3 mb-3 d-flex justify-content-between"><?php echo e($editions->links()); ?>

    <div class="rec-count">Total Records: <?php echo e($editions->total()); ?></div>
</div>
<?php endif; ?>
<ul class="list-group mb-5">
    ...
    <li class="list-group-item d-flex justify-content-between align-items-center mb-3">
        <div><span class="fs-4">Edition Name:</span> <span class="fs-5 ms-4"><?php echo e($e->edition_name); ?></span></div>
        <div class="d-flex">
            <button type="button" class="me-1 btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editEdition-<?php echo e($e->id); ?>">
                Edit
            </button>
            <form action="/editions-delete" method="POST">
                <?php echo csrf_field(); ?>
                <div class="">
                    <input type="hidden" name="edition-id" value="<?php echo e($e->id); ?>">
    ...
    <div class="modal fade" id="editEdition-<?php echo e($e->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/editions-edit" method="POST" class="me-1">
                        ...
                        <div class="">
                            <input type="hidden" name="edition-id" value="<?php echo e($e->id); ?>">
                            <input type="text" class="form-control" id="exampleFormControlInput1" name='edition-name-edit' value="<?php echo e($e->edition_name); ?>">
...
</div><?php /**PATH C:\src\Laravel\mdm-project\resources\views/edition.blade.php ENDPATH**/ ?>